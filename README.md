...
An ec2 instance with AmazonSSMManagedInstanceCore policy included in
its profile, allowing to connect to the instance via AWS SSM's Session
Manager instead of via bastion host.
